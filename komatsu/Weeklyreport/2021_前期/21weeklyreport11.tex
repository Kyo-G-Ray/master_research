...
\end{table}
        ...
        \item 他入力での予測ができるようになったので, それぞれのデータの相関関係をみて適切な入力での予測をおこなえるようにする.
        \item 日付データを数値として, 扱えるようにする.
...
\section{参考文献}
[1]Rosenblatt, F. (1958). The perceptron: A probabilistic model for information storage and organization in the brain. Psychological Review, 65(6), 386\UTF{2013}408.
