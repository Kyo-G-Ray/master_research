...
LSTM（Long Short-Term Memory）は RNN の拡張として 1997 年に Sepp Hochreiter 及び, J\UTF{00FC}rgen Schmidhuber によって発表された時系列データを扱うモデルである\cite{sankou5}.
...
\begin{figure*}[!hb]
  \begin{center}
    \includegraphics[scale=0.17]{image2.eps}
...
\begin{figure*}[!hb]
  \begin{center}
    \includegraphics[scale=0.17]{./image4.eps}
...
\begin{figure*}[!hb]
  \begin{center}
    \includegraphics[scale=0.17]{./image3.eps}
    \caption{降水量の推移}
  \end{center}
\end{figure*}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\bibitem{sankou5}
%これはLstmの論文でOK
Sepp Hochreiter; J\UTF{00FC}rgen Schmidhuber (1997). Long short-term memory. Neural Computation 9 (8): 1735\UTF{2013}1780.

\bibitem{sankou6}
Williams, Ronald J.; Hinton, Geoffrey E.; Rumelhart, David E. (October 1986). Learning representations by back-propagating errors. Nature 323 (6088): 533\UTF{2013}536. doi:10.1038/323533a0. ISSN 1476-4687.
%\section{参考文献}
